...
class Dataset:
    ...
    def trainLoader(self):
        ...
        print('Training samples: {}'.format(len(self.train_files)))
    ...
    def valLoader(self):
        ...
        print('Validation samples: {}'.format(len(self.val_files)))
    ...
    def testLoader(self, single_file=None):
        if single_file:
            self.test_file_names = [single_file]
        else:
    ...
    def demoLoader(self, scan_test_path):
        self.test_file_names = sorted(glob.glob(os.path.join(scan_test_path, '*' + self.filename_suffix)))
        self.test_files = [torch.load(i) for i in self.test_file_names]
